  ...
  return (
    <div className="main-container">
      ...
      <div className="eventos">
        ...
        {loading && <p style={{ color: "#fff" }}>Cargando eventos...</p>}

        {!loading && error ? (
          <p style={{ color: "#ff5252" }}>{error}</p>
        ) : eventos.length === 0 ? (
          <p style={{ color: "#fff" }}>No hay eventos en el historial.</p>
        ) : (
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      ...
                      <span
                        style={{
                          ...
                          borderRadius: "12px",
                          color: "#fff",
                          background: estado === "Activo" ? "#43e97b" : "#e53935",
                          fontWeight: "bold",
                          fontSize: "1em",
                          marginLeft: "16px",
                        }}
                    ...
                    <p style={{ margin: "10px 0 0 0", color: "#fff" }}>
                      <b style={{ color: "#ffd600" }}>Tipo:</b> <span style={{ color: "#b3e5fc" }}>{evento.tipo}</span>
                    </p>
                    <p style={{ margin: "4px 0", color: "#fff" }}>
                      <b style={{ color: "#ffd600" }}>Fecha:</b>{" "}
                      <span style={{ color: "#b3e5fc" }}>{evento.fecha}</span>
                    </p>
                    <p style={{ margin: "4px 0", color: "#fff" }}>
                      <b style={{ color: "#ffd600" }}>Organizador:</b>{" "}
                      <span style={{ color: "#b3e5fc" }}>{evento.nombreOrganizador}</span>
                    </p>
                    <p style={{ margin: "4px 0", color: "#fff" }}>
                      <b style={{ color: "#ffd600" }}>Empresa Patrocinadora:</b>{" "}
